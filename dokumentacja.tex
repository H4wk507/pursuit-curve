...
\textbf{Wyprowadzenie wzoru:} Jest to klasyczny wynik znany jako ,,problem $n$ myszy'' (ang. \textit{n-bug problem}). Rozważmy $n$ agentów ustawionych na wierzchołkach foremnego $n$-kąta wpisanego w okrąg o promieniu $R$. Każdy agent goni następnego z prędkością $v$.
